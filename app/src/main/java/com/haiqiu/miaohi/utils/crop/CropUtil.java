...
class CropUtil {
    ...
    public static File getFromFile(String path){
...
//                activity, title, message, true, false);
        CircleLoadingProgressDialog loadingProgress = new CircleLoadingProgressDialog(activity);
        loadingProgress.setMessage(message);
        loadingProgress.setCancelable(false);
        loadingProgress.show();
        new Thread(new BackgroundJob(activity, job, loadingProgress, handler)).start();
    }

    private static class BackgroundJob extends MonitoredActivity.LifeCycleAdapter implements Runnable {

        private final MonitoredActivity activity;
        private final CircleLoadingProgressDialog dialog;
        ...
        public BackgroundJob(MonitoredActivity activity, Runnable job,
                             CircleLoadingProgressDialog dialog, Handler handler) {
