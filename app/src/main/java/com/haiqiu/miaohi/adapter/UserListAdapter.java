...
/**
 * Created by zhandalin on 2016-12-22 20:15.
 * 说明:用户列表
 */
public class UserListAdapter extends BaseAdapter {
    ...
    /**
     * @param isEnableSelected 样式是否可选
     */
    public UserListAdapter(Context baseActivity, List<UserData> dataList, boolean isEnableSelected) {
        ...
        height = DensityUtil.dip2px(baseActivity, 70.5f);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(baseActivity, R.layout.item_user_list_1, null);
    ...
    public class ViewHolder {
        ...
        public ViewHolder(View rootView) {
            ...
            rootView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height));
    ...
    public void addData(List<UserData> mList) {
        if (null == mList || mList.size() == 0) return;
        this.dataList.addAll(mList);
        notifyDataSetChanged();
    }

    public void changeList(List<UserData> dataList) {
