...
public interface IPhotoView {
    ...
    public static final int DOUBLETAPSCALE_SINGLE = 1;//可双击一次放大
    public static final int DOUBLETAPSCALE_Double = 2;//可双击两次放大
    ...
    /**
     * 设置 缩放是否可以缩放到scale < 1  缺省为true
     * @param enable true 可以 ,false 不可以
     */
    void setZoomLessThanEnable(boolean enable);

    /**
     * 设置 双击图片放大次数 目前只有两种一次和两次 缺省为一次
     * @param tapScaleCount
     */
    void setDoubleTapScaleCount(int tapScaleCount);
}
