...
public class RefreshingView extends View {
    ...
    private RefreshingIndicator mIndicatorController;
    ...
    public RefreshingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void applyIndicator() {
        mIndicatorController = new RefreshingIndicator();
