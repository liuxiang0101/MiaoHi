 ...
 */
package com.haiqiu.miaohi.widget.viewpagerindicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            RectF rect = new RectF(dx1, verticalOffset - getStrokeWidth(), dx2, verticalOffset);
            canvas.drawRoundRect(rect, mCornerRadius, mCornerRadius, (i == mCurrentPage) ? mPaintSelected : mPaintUnselected);
    ...
    private int measureHeight(int measureSpec) {
        ...
        if (specMode == MeasureSpec.EXACTLY) {
            //We were told how big to bestrokke
            result = specSize;
        } else {
            //Measure the height
