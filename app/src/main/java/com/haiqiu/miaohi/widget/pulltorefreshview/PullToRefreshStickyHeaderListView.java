...
import com.haiqiu.miaohi.widget.stickyheaderListView.WrapperViewList;

/**
 * Created by ningl on 16/12/4.
 */
public class PullToRefreshStickyHeaderListView extends PullToRefreshBase<StickyListHeadersListView> implements AbsListView.OnScrollListener {
     ...
     * @param attrs   attrs
     */
    public PullToRefreshStickyHeaderListView(Context context, AttributeSet attrs) {
     ...
     */
    public PullToRefreshStickyHeaderListView(Context context, AttributeSet attrs, int defStyle) {
...
//        mListView.setOnScrollListener(this);
    ...
    private boolean isFirstItemVisible() {
        ...
        if (mListView.getHeaderViewsCount() <= 0 && (null == adapter || adapter.isEmpty())) {
            return true;
        }
