...
/**
 * Created by zhandalin on 2016-09-08 10:23.
 * 说明:
 */
public class GPUVideoPreviewView extends GLSurfaceView implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {

    public static final String TAG = "GPUVideoPreviewView";
    ...
    public interface PlayerInitializeCallback {
        ...
        void initPlayer(MyMediaPlayer player);
    }
    ...
    public interface PlayCompletionCallback {
        ...
        */
        boolean playFailed(IMediaPlayer mp, int what, int extra);
    }
            ...
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mSurfaceTexture == null || mVideoTextureID == 0) {
                        ...
                        mSurfaceTexture.setOnFrameAvailableListener(GPUVideoPreviewView.this);
                    }
                    _useUri();
                }
            });
    ...
    public void setMaskBitmap(final Bitmap bmp, final boolean shouldRecycle, final SetMaskBitmapCallback callback) {
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mFrameRenderer == null) {
                    MHLogUtil.e(TAG, "setMaskBitmap after release!!");
                    return;
                }
    ...
    public synchronized MyMediaPlayer getPlayer() {
        if (mPlayer == null) {
            MHLogUtil.e(TAG, "Player is not initialized!");
        }
        return mPlayer;
    }
    ...
    public GPUVideoPreviewView(Context context, AttributeSet attrs) {
        ...
        MHLogUtil.i(TAG, "MyGLSurfaceView Construct...");
        ...
        MHLogUtil.i(TAG, "MyGLSurfaceView Construct OK...");
    }

    @Override
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {

        MHLogUtil.i(TAG, "video player onSurfaceCreated...");
    ...
    @Override
    public void onPause() {
        MHLogUtil.i(TAG, "surfaceview onVideoPause ...");
        super.onPause();
    }
    ...
    private void _useUri() {
        ...
        mPlayer.setOnCompletionListener(new IMediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(IMediaPlayer mp) {
                ...
                MHLogUtil.i(TAG, "Video Play Over");
            }
        });
        mPlayer.setOnPreparedListener(new IMediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(IMediaPlayer mp) {
                ...
                MHLogUtil.i(TAG, String.format("Video resolution 1: %d x %d", mVideoWidth, mVideoHeight));
            }
        });
        ...
        try {
            ...
            MHLogUtil.i(TAG, String.format("Error handled: %s, play failure handler would be called!", e.toString()));
            if (mPlayCompletionCallback != null) {
                this.post(new Runnable() {
                    @Override
                    public void run() {
