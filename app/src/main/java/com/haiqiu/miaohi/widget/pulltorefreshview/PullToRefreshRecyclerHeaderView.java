...
/**
 * Created by zhandalin on 2017-01-03 17:44.
 * 说明:
 */
public class PullToRefreshRecyclerHeaderView extends PullToRefreshBase<RecyclerViewHeader> {
    RecyclerView.LayoutManager layoutManager;
    private int visibleItemCount;
    private int totalItemCount;
    private int firstVisibleItem;
    private RecyclerViewHeader recyclerView;
    private boolean lastItemVisible;

    public PullToRefreshRecyclerHeaderView(Context context) {
        super(context);
    }

    public PullToRefreshRecyclerHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshRecyclerHeaderView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @Override
    protected RecyclerViewHeader createRefreshableView(Context context, AttributeSet attrs) {
        recyclerView = new RecyclerViewHeader(context, attrs);
