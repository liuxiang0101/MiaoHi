 ...
 */
public class PullToRefreshZoomRecyclerHeaderView extends PullToRefreshBase<PullZoomRecyclerView> {
    ...
    public PullToRefreshZoomRecyclerHeaderView(Context context) {
        super(context);
    }

    public PullToRefreshZoomRecyclerHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshZoomRecyclerHeaderView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @Override
    protected PullZoomRecyclerView createRefreshableView(Context context, AttributeSet attrs) {
        recyclerView = new PullZoomRecyclerView(context, attrs);
