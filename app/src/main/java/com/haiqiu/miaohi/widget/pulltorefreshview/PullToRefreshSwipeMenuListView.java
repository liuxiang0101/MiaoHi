 ...
 */
public class PullToRefreshSwipeMenuListView extends PullToRefreshBase<SwipeMenuListView> implements AbsListView.OnScrollListener {
    /**
     * ListView
     */
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (null != onDispatchTouchEventListener)
