package com.haiqiu.miaohi.widget.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        tab_gravity = ta.getInt(R.styleable.SlidingTabLayout_tl_tab_gravity, Gravity.CENTER);

        ta.recycle();
    }

    /**
     * 关联ViewPager,请在setAdapter之后调用
     */
    ...
    /**
     * 关联ViewPager,用于不想在ViewPager适配器中设置titles数据的情况,请在setAdapter之后调用
     */
    ...
    /**
     * 关联ViewPager,用于连适配器都不想自己实例化的情况,请在setAdapter之后调用
     */
    ...
    private void addTab(final int position, String title, View tabView) {
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_slidetab_title);
        tv_tab_title.setGravity(tab_gravity);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_title = (TextView) v.findViewById(R.id.tv_slidetab_title);
            if (tv_tab_title != null) {
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView tab_title = (TextView) tabView.findViewById(R.id.tv_slidetab_title);

            if (tab_title != null) {
                tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
                if (isNeedAnim())
                    if (isSelect) {
                        tab_title.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 17);
                    } else {
                        tab_title.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 15);
                    }
            }
        }
    }
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            TextView tab_title = (TextView) currentTabView.findViewById(R.id.tv_slidetab_title);
            mTextPaint.setTextSize(mTextsize);
            //比文字略宽一点
            float textWidth = mTextPaint.measureText(tab_title.getText().toString()) + dp2px(10);
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            //for mIndicatorWidthEqualTitle
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                TextView next_tab_title = (TextView) nextTabView.findViewById(R.id.tv_slidetab_title);
                mTextPaint.setTextSize(mTextsize);
                //比文字略宽一点
                float nextTextWidth = mTextPaint.measureText(next_tab_title.getText().toString()) + dp2px(10);
