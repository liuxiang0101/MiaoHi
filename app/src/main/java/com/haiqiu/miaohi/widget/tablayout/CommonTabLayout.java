...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static final int STYLE_ARC = 3;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, dp2px(14));
        ...
        tab_gravity = ta.getInt(R.styleable.CommonTabLayout_tl_tab_gravity, Gravity.CENTER);
        ta.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.tab_layout_right, null);
            tabView.setTag(i);
            addTab(i, tabView);
        }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_ARC) {
            arcRectF = new RectF(mIndicatorRect);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (mIndicatorStyle == STYLE_ARC) {
            if (mIndicatorHeight > 0) {
                mTrianglePaint.setColor(mIndicatorColor);
                arcRectF.left = paddingLeft + mIndicatorMarginLeft + mIndicatorRect.left;
                arcRectF.right = paddingLeft + mIndicatorRect.right - mIndicatorMarginRight;
                arcRectF.bottom = height + mIndicatorHeight;
                arcRectF.top = height - mIndicatorHeight;
                canvas.drawArc(arcRectF, 0, -180, false, mTrianglePaint);
            }
        } else {
