...
package com.haiqiu.miaohi.widget.staggeredgridview;
...
public abstract class ExtendableListView extends AbsListView {
    ...
    // ItemClick support from AdapterView
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        //  handle focus and its impact on selection - if we add item selection support
    }
    ...
    private boolean onTouchDown(final MotionEvent event) {
        ...
        //  use the motion position for fling support
        //  support long press!
        // startLongPressCheck();
    ...
    private void setupChild(View child, int position, int y, boolean flowDown,
        ...
        final boolean isSelected = false; //  selected && shouldShowSelector();
    ...
    public Parcelable onSaveInstanceState() {
        ...
        //  sync selection when we handle it
