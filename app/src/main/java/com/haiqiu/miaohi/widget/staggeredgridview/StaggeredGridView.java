...
public class StaggeredGridView extends ExtendableListView {
    ...
    public StaggeredGridView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (attrs != null) {
            ...
            mColumnCount = 2; // determined onMeasure
            mItemMargin = DensityUtil.dip2px(context, 10);
        }
    ...
    protected void onMeasureChild(final View child, final LayoutParams layoutParams) {
        ...
        if (viewType == ITEM_VIEW_TYPE_HEADER_OR_FOOTER ||
            ...
            if (layoutParams.height > 0) {
                ...
                childHeightSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
            }
    ...
    /**
     * 设置item间距
     * @param itemMargin dp值
     */
    public int setItemMargin(int itemMargin){
        return DensityUtil.dip2px(getContext(), itemMargin);
    }
}
